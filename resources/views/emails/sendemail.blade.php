...
<p style="margin:0"><b>Xin chào bạn {{ $contact->name }}</b></p>

<p>Yêu cầu của bạn đã được tiếp nhận.  Chúng tối sẽ  liên hệ lại với bạn trong thời gian sớm nhất.</p>
</div>

<div style="margin-top:23px">
<p></p><div style="font-size:18px;text-align:center;font-weight:600;color:#2d82c4;margin-bottom:18px">Nội dung yêu cầu của bạn</div>
<div style="margin:0px 20px 10px 20px;border-top:1px solid #eeeeee;display:block">
  <div>
    <p style="font-weight:300;font-size:16px;margin-bottom:5px;color:#363636">Tên</p>
    <p style="margin-top:0px;margin-bottom:10px;color:#757575">{{$contact->name}}</p>
    <p style="font-weight:300;font-size:16px;margin-bottom:5px;color:#363636">Email</p>
    <p style="margin-top:0px;margin-bottom:10px;color:#757575">{{$contact->email}}</p>
    <p style="font-weight:300;font-size:16px;margin-bottom:5px;color:#363636">Nội dung</p>
    <p style="margin-top:0px;margin-bottom:10px;color:#757575">{{$contact->content}}</p>
  </div>
</div><p></p>
...
<div>&nbsp;<img height="1" src="https://ci4.googleusercontent.com/proxy/rZ2RlsW2DkgnVE2Z6MNndLjetE75iJxaCQhv2OskIo6XYX-2h20WM2yoKqx08EoYUsFvuS8qHztl1qCKGV_8Eey-0h2GxwznupoYTmfQUu9Nh01iPIfQSO79wEY=s0-d-e1-ft#https://www.timviecnhanh.com/mail-tracking?&amp;l=Mjk2ODYzNF8xODAxMTEyMw==" width="1" class="CToWUd"><img height="1" src="https://ci6.googleusercontent.com/proxy/ON4NEm7xwPJrs0f-kJmGQvBOMzThOpkTHscMldiTVv7OeknDxbsHiPmzeaZwae5sY72bfMudlE_IMsT_l_pUc8jOnFX_4KdvihnsfC5jThp73K_xVico0GEldsyu11BGBocjEx4a9iKJhwEQyQnwM9xG6jPPP1_vXaMSlepB5fOYuxGvn3CziyLa8rAydIQHiSHisajBjn8CFAOwSs4IxbJxx696owLfMlS7qV9GqSc5Cc0=s0-d-e1-ft#http://www.google-analytics.com/collect?v=1&amp;tid=UA-1771947-29&amp;cid=2968634_18011123&amp;t=event&amp;ec=email&amp;ea=open&amp;el=2968634_18011123&amp;cs=tbvl&amp;cm=email&amp;cn=18011123" width="1" class="CToWUd"></div><div class="yj6qo"></div><div class="adL">
